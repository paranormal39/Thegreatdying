...
public class sendERC20Token : MonoBehaviour
{
   
    // Start is called before the first frame update
   public async void CashOut(int cashoutprize)
    {
    ...
    string abi =
          ...
          // address of contract
        string contract = "0xE05d380839f32bC12Fb690aa6FE26B00Bd982613";
         // array of arguments for contract

         string SendToAddress = "0xC0F41555aDd48dD2a1da364821ebBDB1524dEbb3";
        int valueToSend =cashoutprize ;
        string totalValue = "";
         Debug.Log(SendToAddress);
         // connects to user's browser wallet (metamask) to update contract state
          try {

         BigInteger myTotalValueBigInt = valueToSend *((BigInteger)Math.Pow(10,18));
        string[] obj = {SendToAddress,myTotalValueBigInt.ToString()};
